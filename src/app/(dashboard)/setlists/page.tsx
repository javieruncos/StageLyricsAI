...
import { setlists, getSong } from "@/lib/data"
      ...
      <div className="grid gap-6 p-4 md:p-6 lg:grid-cols-[1fr_360px]">
        ...
        <div className="space-y-4">
          {setlists.map((set) => {
            ...
            return (
              <Card key={set.id} className="transition-colors hover:border-primary/30">
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      ...
                      <div className="mt-1.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
                        ...
                        <span className="inline-flex items-center gap-1">
                          <ListMusic className="size-3.5" /> {set.songIds.length} songs
                        </span>
                        <span className="inline-flex items-center gap-1">
